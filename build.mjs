...
for(const file of ['index.html','style.css','theme.css','beta-theme.css','mobile-clans.css','visual-theme.css','clans-ui.js','profile-ui.js','game.js','config.js','client-api.js','friends-ui.js','art.js','balance.js','assets'])cpSync(file,'dist/client/'+file,{recursive:true});
