...
for(const file of ['ui-icons.js','index.html','style.css','theme.css','beta-theme.css','mobile-clans.css','visual-theme.css','raid-view.js','landscape-ui.js','landscape.css','raid-layout.css','rare-raids.js','vehicles.js','garage-ui.js','ads-ui.js','ads-bridge.js','onboarding.js','conflict-ui.js','clans-ui.js','profile-ui.js','game.js','config.js','client-api.js','friends-ui.js','art.js','balance.js','assets'])cpSync(file,'dist/client/'+file,{recursive:true});
