...
export const VEHICLES=[
 ...
 ['interceptor','Перехватчик','Патрульный автомобиль',25,16000,9,4,0,'Боевой выезд: высокий урон при небольшом грузовом отсеке.'],
 ...
 ['vault','Сейф','Бронефургон',90,46000,3,13,5,'Бронеплиты для выживания под давлением орды.'],
 ['engineer','Монтажник','Сервисный грузовик',130,62000,5,7,13,'Мастерская на колёсах. Максимум полезной добычи.'],
 ['bastion','Бастион','Бронетранспортёр',200,84000,10,14,3,'Шесть колёс и тяжёлая защита для передовой.'],
 ['command','Комендант','Командный автобус',300,112000,12,10,10,'Подвижный штаб для командира убежища.'],
 ['ark','Ковчег','Экспедиционный грузовик',450,152000,10,15,15,'Дальние маршруты и большой запас прочности.']
